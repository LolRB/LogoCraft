...
describe("SVG Class", () => {
  ...
  describe("Text Handling", () => {
    test("should append text element", () => {
      const expectedSvg =
        '<svg version="1.1" width="400" height="300" xmlns="http://www.w3.org/2000/svg"><text x="200" y="200" font-size="80" text-anchor="middle" fill="yellow">A</text></svg>';
    ...
    test("should set text message and color", () => {
      const expectedSvg =
        '<svg version="1.1" width="400" height="300" xmlns="http://www.w3.org/2000/svg"><text x="200" y="200" font-size="80" text-anchor="middle" fill="#666">SVG</text></svg>';
      svg.setText("XYZ", "#666");
      expect(svg.render()).toBe(expectedSvg);
    });
    ...
    test("should include a background", () => {
      ...
      const expectedSvg = `
        <svg version="1.1" width="400" height="300" xmlns="http://www.w3.org/2000/svg">
          ...
          <text x="200" y="200" font-size="80" text-anchor="middle" fill="#666">SVG</text>
        </svg>
      `.replace(/\s+/g, "");
